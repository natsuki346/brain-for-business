...
const QUESTIONS: { text: string; exampleTags: string[] }[] = [
  {
    ...
    exampleTags: ['決めたことは最後までやり切れる', '複雑なことをわかりやすく伝えられる', '困っている人を見たら放っておけない'],
  },
  {
    text: '最近、仕事でモヤモヤしていることや、\nなんとなく引っかかっていることはありますか？',
    exampleTags: ['得意なことを活かせていない気がする', '自分のペースで仕事ができない', '頑張っても手応えを感じられない'],
  },
  {
    text: '職場での人との関わりで、うまくいっていると感じることや、\n逆に難しいと感じることはありますか？',
    exampleTags: ['チームの雰囲気を大切にできる', '上司に本音を話せない', '本音で話せる同僚がいない'],
  },
  {
    text: '今の自分の状態について、誰かに正直に話すとしたら\n何を話したいですか？',
    exampleTags: ['将来のキャリアが全く見えない', '職場での孤独感がずっと続いている', '自分の悩みをわかってもらえる人がいない気がする'],
  },
]
